  ...
  return (
    <div className="h-[48px] relative rounded-[8px] shrink-0 w-[108.023px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[48px] relative w-[108.023px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[63.84px] not-italic text-[16px] text-center text-nowrap text-white top-[12px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre">Wstecz</p>
